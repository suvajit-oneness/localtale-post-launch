    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="tile">
                ...
                <hr>
                <form action="{{ route('admin.localtrade.question.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="tile-body">
                        <div class="form-group">
                            <label class="control-label" for="name">Question <span class="m-l-5 text-danger"> *</span></label>
                            <input class="form-control @error('question') is-invalid @enderror" type="text" name="question" id="question" value="{{ old('question') }}" placeholder="eg: What is your postcode" autofocus/>
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <input type="radio" name="type" id="type1" value="text" checked>
                            <label for="type1" class="mr-3">Small text</label>

                            <input type="radio" name="type" id="type2" value="textarea">
                            <label for="type2" class="mr-3">Bigger text</label>

                            <br>

                            <input type="radio" name="type" id="type3" value="select">
                            <label for="type3" class="mr-3">Select-options (Answer required)</label>

                            <input type="radio" name="type" id="type4" value="radio">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" id="name" value="{{ old('name') }}" placeholder="eg: postcode"/>
                            <p class="text-danger small">@error('name') {{ $message ?? '' }} @enderror</p>
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="name">Option</label>
                            <input class="form-control @error('answer') is-invalid @enderror" type="text" name="answer" id="answer" value="{{ old('answer') }}" placeholder="Use only for Select-options/ Radio-options | Comma seperated | eg: option1, option2, option3"/>
