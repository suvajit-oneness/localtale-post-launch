    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="tile">
                ...
                <form action="{{ route('admin.suburb.update') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="tile-body">
                        <div class="form-group">
                            <label class="control-label" for="name">Name <span class="m-l-5 text-danger"> *</span></label>
                            <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" id="name" value="{{ old('name', $suburb->name) }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="pin_code">
                                ...
                                <option value="{{$item->id}}" {{ ($item->id == $suburb->pin_code) ? 'selected' : '' }}>{{ $item->pin }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="tile-footer">
                        <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Update State</button>
                        &nbsp;&nbsp;&nbsp;
