                ...
                <form action="{{ route('admin.pin.update') }}" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('pin') is-invalid @enderror" type="text" name="pin" id="pin" value="{{ old('pin', $targetpin->pin) }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="state_id">
                                ...
                                <option value="{{$item->id}}" {{ ($item->id == $targetpin->state_id) ? 'selected' : '' }}>{{ $item->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="tile-footer">
                        <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Update Pincode</button>
                        &nbsp;&nbsp;&nbsp;
