...
<section class="page-banner" style="background: url({{asset('site/images/banner')}}-image.jpg) no-repeat center center; background-size:cover;">
	<div class="container">
		<div class="page-title">Local Events</div>
					  	...
					  	<div class="tab-pane fade" id="gird" role="tabpanel" aria-labelledby="gird-tab">
					  		...
					  		<ul class="search_list_items grid">
					  			...
					  			<li class="p-0">
									...
									<p class="history_details">{!!strip_tags(substr($event->description,0,180))!!}...</p>
						  			<a href="{!! URL::to('directory-details/'.$event->id.'/'.strtolower(preg_replace("/[^a-zA-Z0-9]+/", "-", $event->title))) !!}" class="location_btn">View Details <img src="{{asset('site/images/right-arrow.png')}}"></a>
