                    ...
                    <div class="card border-0 px-2 px-md-4 py-3 py-md-5">
                      <form action="{{ route('site.register.post') }}" method="POST" role="form">
                        ...
                        <div class="row px-3"> <label class="mb-1">
                            ...
                            </label> <input class="mb-4" type="text" name="name" placeholder="Enter a valid name" required="required"> </div>
                        <div class="row px-3"> <label class="mb-1">
                                <h6 class="mb-0 text-sm text-dark">Email Address</h6>
                            </label> <input class="mb-4" type="text" name="email" placeholder="Enter a valid email address" required="required"> </div>
                        <div class="row px-3"> <label class="mb-1">
                                <h6 class="mb-0 text-sm text-dark">Mobile No</h6>
                            </label> <input class="mb-4" type="text" name="mobile" placeholder="Enter a valid mobile no" required="required"> </div>

                        <div class="row px-3"> <label class="mb-1">
                                <h6 class="mb-0 text-sm text-dark">Password</h6>
                            </label> <input type="password" name="password" placeholder="Enter password" required="required"> </div>
