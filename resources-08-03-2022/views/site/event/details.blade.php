		...
		<div class="row m-0 mt-4 mb-5">
			<div class="col-md-12 pl-2 pl-md-0 details_left">
				<div class="card position-relative">
					...
					@if($eventSaved==1)
					<a href="{!! URL::to('site-delete-user-event/'.$event->id) !!}" class="btn btn-blue text-center">Remove</a>
					@else
					<a href="{!! URL::to('site-save-user-event/'.$event->id) !!}" class="btn btn-blue text-center">Save Event</a>
					@endif
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#deals" role="tab">Details</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#about" role="tab">Contact Information</a>
						</li>
						<li class="nav-item">
